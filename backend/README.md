...
## Project Structure
    ...
    ├── ideapros_llc_lofty_32436  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_lofty_32436`
...
2. Clone this repo and `cd ideapros_llc_lofty_32436`
